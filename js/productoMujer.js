...
function loadJSON() {
  ...
  $.getJSON("../json/productos.json", function (json) {
    if (json.clothes) {
      json.clothes.filter(f => f.gender == "female" || f.gender == "both").slice(0,6).forEach ( item => {
        $('#product').append('\
        <div class="col-lg-4 col-md-6 mb-4">\
          <div class="card h-100">\
            <a href="../product.html?id=' + item.id + '"><img class="card-img-top" src="/DAW1/' + item.img + '" alt=""></a>\
            <div class="card-body">\
